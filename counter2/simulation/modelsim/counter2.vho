...
-- CNT_EN	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- RST_CNT	=>  Location: PIN_M6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \RST_CNT$latch~combout\ : std_logic;
...
-- Equation(s):
-- \Selector2~0_combout\ = (\present_state.clean~q\ & (((!\Div2CLK~q\) # (!\CLKK~input_o\)))) # (!\present_state.clean~q\ & (\present_state.lock~q\ & (!\CLKK~input_o\ & !\Div2CLK~q\)))
...
\RST_CNT$latch\ : cycloneive_lcell_comb
-- Equation(s):
-- \RST_CNT$latch~combout\ = (\present_state.clean~q\ & ((!\CLKK~input_o\))) # (!\present_state.clean~q\ & (\RST_CNT$latch~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \RST_CNT$latch~combout\,
	datac => \present_state.clean~q\,
	datad => \CLKK~input_o\,
	combout => \RST_CNT$latch~combout\);
