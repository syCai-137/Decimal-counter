...
vcom -93 -work cycloneive {d:/quartus/quartus/eda/sim_lib/cycloneive_atoms.vhd}
vcom -93 -work cycloneive {d:/quartus/quartus/eda/sim_lib/cycloneive_components.vhd}
...
vcom -93 -work work {E:/homework1/counter2/counter2.vhd}

vcom -93 -work work {E:/homework1/counter2/simulation/modelsim/counter2.vho}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneive -L rtl_work -L work -voptargs="+acc"  counter2
